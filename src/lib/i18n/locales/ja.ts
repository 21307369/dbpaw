...
export const ja: Translations = {
  ...
  settings: {
    ...
    mcp: {
      ...
      transport: {
        title: "トランスポートモード",
        stdio: "stdio — ローカル AI クライアント（デフォルト）",
        http: "http — リモート/ネットワークアクセス",
        both: "both — 両方のモードをサポート",
        httpConfig: "HTTP 設定",
        host: "ホスト",
        port: "ポート",
      },
      ...
      clients: {
        ...
        notDetected: "未検出",
        reconfigure: "再設定",
        configureAll: "検出されたすべてのクライアントを設定",
        configuring: "設定中...",
        success: "設定成功",
        error: "設定失敗",
      },
  ...
  redis: {
    browser: {
      scanFailed: "キーのスキャンに失敗しました",
      loadDatabasesFailed: "Redis データベースの読み込みに失敗しました",
      batchKeysFailed: "{{count}} 件のキーが失敗しました",
      batchOperationFailed: "バッチ操作に失敗しました",
      mgetFailed: "MGET に失敗しました",
      invalidFormat: "無効なフォーマットです",
      msetFailed: "MSET に失敗しました",
      readFileFailed: "ファイルの読み取りに失敗しました",
      copyFailed: "コピーに失敗しました",
      exportFailed: "エクスポートに失敗しました",
    },
    key: {
      loadFailed: "Redis キーの読み込みに失敗しました",
      loadMoreFailed: "アイテムの追加読み込みに失敗しました",
      invalidTtl: "無効な TTL です",
      updateTtlFailed: "TTL の更新に失敗しました",
      saveFailed: "Redis キーの保存に失敗しました",
      operationFailed: "操作に失敗しました",
      bitmapUpdateFailed: "ビットマップの更新に失敗しました",
      incrementFailed: "インクリメントに失敗しました",
      scoreUpdateFailed: "スコアの更新に失敗しました",
      popMinFailed: "最小値のポップに失敗しました",
      popMaxFailed: "最大値のポップに失敗しました",
    },
    stream: {
      invalidRange: "無効なストリーム範囲です",
      loadFailed: "ストリームエントリの読み込みに失敗しました",
      loadMoreFailed: "ストリームエントリの追加読み込みに失敗しました",
      createGroupFailed: "グループの作成に失敗しました",
      deleteGroupFailed: "グループの削除に失敗しました",
      resetCursorFailed: "グループカーソルのリセットに失敗しました",
      loadPendingFailed: "保留情報の読み込みに失敗しました",
      loadPendingEntriesFailed: "保留エントリの読み込みに失敗しました",
